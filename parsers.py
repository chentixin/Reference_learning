...
parser.add_argument('--P', type=int, default=0.1, help='能量传输功率')
parser.add_argument('--B_max', type=int, default=100, help='每隔时隙生成最大任务')
...
# 参数定义
parser.add_argument('--actor_lr', type=float, default=1e-5, help='策略网络的学习率')
parser.add_argument('--critic_lr', type=float, default=5e-4, help='价值网络的学习率')
parser.add_argument('--n_hiddens', type=int, default=512, help='隐含层神经元个数')
parser.add_argument('--gamma', type=float, default=0.98, help='折扣因子')
parser.add_argument('--tau', type=float, default=0.05, help='软更新系数')
parser.add_argument('--buffer_size', type=int, default=5000, help='经验池容量')
parser.add_argument('--min_size', type=int, default=60, help='经验池超过120再训练')
parser.add_argument('--batch_size', type=int, default=60, help='每次训练多少组样本')
